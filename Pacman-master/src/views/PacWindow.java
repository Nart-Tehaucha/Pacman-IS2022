...
//            }
	...
	// Classifies all the walls on the map and gives each one a number representing
	// it's type
	// For example:
	// Horizontal wall = 20
	// Vertical wall = 24
	// Corner walls = 10, 11, 12, 13 (depending on which corner)
	// This is done for the purpose of loading a different image for each type of
	// wall.
